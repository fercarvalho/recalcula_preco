...
interface AdicionarCategoriaModalDemoProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (nome: string, icone: string | null) => Promise<void>;
}

const AdicionarCategoriaModalDemo = ({ isOpen, onClose, onSave }: AdicionarCategoriaModalDemoProps) => {
...
export default AdicionarCategoriaModalDemo;
